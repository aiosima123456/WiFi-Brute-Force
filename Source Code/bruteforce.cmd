@echo off
	...
	echo.
	call colorchar.exe /0e "                    Developed By TUX & Updated By Yasharth"
	echo.
	echo  [---------------------------------------------------------------------------]
	echo.
	...
	if !mainmenuchoice!==help (
		...
		echo.
		echo  This devloper is not responsible for the actions done by the user of this project.
		echo.
		...
		echo.
		echo  This project's password list has been updated by Yasharth.
		echo  "https://www.discord.com/404"
		echo.
		echo  Press any key to continue...
		pause >nul
		cls
